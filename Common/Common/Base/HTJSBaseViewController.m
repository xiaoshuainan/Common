...
#import "HTJSBaseViewController.h"
#import "HTJSBaseNavigationViewController.h"

@interface HTJSBaseViewController ()

@end

@implementation HTJSBaseViewController
...
- (void)pushViewControllerWithName:(id)classOrName {
    if (classOrName) {
        ...
        } else if ([classOrName isSubclassOfClass:[HTJSBaseViewController class]]) {
            classs = classOrName;
        }
