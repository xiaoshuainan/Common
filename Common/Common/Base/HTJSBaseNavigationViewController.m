//
//  HTJSBaseNavigationViewController.m
//  Common
//
...
@interface HTJSBaseNavigationViewController ()<UIGestureRecognizerDelegate>

@end

@implementation HTJSBaseNavigationViewController
